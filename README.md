...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create OnboardingRemix_Shadcn-7921
  fly apps create OnboardingRemix_Shadcn-7921-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app OnboardingRemix_Shadcn-7921
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app OnboardingRemix_Shadcn-7921-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'OnboardingRemix_Shadcn-7921-staging' does not match app name in config file 'OnboardingRemix_Shadcn-7921'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name OnboardingRemix_Shadcn-7921-db
  fly postgres attach --app OnboardingRemix_Shadcn-7921 OnboardingRemix_Shadcn-7921-db

  fly postgres create --name OnboardingRemix_Shadcn-7921-staging-db
  fly postgres attach --app OnboardingRemix_Shadcn-7921-staging OnboardingRemix_Shadcn-7921-staging-db
  ```
